        ...
        <div class="container">
            <div class="row">
                <div class="page_title_banner_cell_text text-center">
                    <h2 class="wow fadeInUp" data-wow-delay="500ms"><?php printf(esc_html__('Search Results for %s','themx'),'<span>'.esc_html(get_search_query()).'</span>');?></h2>
                </div>
            </div>
        </div><!--container-->
    </div><!--B_latest_news-->
        ...
        <div class="row">
            ...
            <div class="col-md-3">
                <div class="blog_right_sidebaR">
                    <?php 
                        dynamic_sidebar('themx-blog-sidebar');
                    ?>
